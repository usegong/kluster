  ...
  return (
    <html lang="en">
      ...
      >
        ...
        />
        <div className="flex-1 flex flex-col space-y-32 bg-gradient-to-bl from-black via-green-900/50 to-black  2xl:self-cente overflow-y-scroll overflow-x-hidden">
          <LayoutHeader />
          {children}
          <LayoutFooter />
        </div>
